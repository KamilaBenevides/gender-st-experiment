#' ---
#' title: "ANCOVA test for `fss`~`dfs`+`Condition`"
...
#' 
## ---- echo=FALSE--------------------------------------------------------------
car::Boxplot(`fss` ~ `Condition`, data = dat[["fss"]], id = list(n = Inf))
...
#' ### Textual Report
#' 
#' After controlling the linearity of covariance "dfs", ANCOVA tests with independent between-subjects variables "Condition" (inThreat, inBoost, control) were performed to determine statistically significant difference on the dependent varibles "fss". For the dependent variable "fss", there was statistically significant effects in the factor "dfs" with F(1,103)=8.985, p=0.003 and ges=0.08 (effect size).
#' 
#' 
#' 
#' 
